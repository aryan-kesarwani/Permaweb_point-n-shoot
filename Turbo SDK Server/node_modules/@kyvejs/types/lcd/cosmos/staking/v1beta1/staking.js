...
(function (Infraction) {
    ...
    Infraction["INFRACTION_UNSPECIFIED"] = "INFRACTION_UNSPECIFIED";
    /** INFRACTION_DOUBLE_SIGN - DOUBLE_SIGN defines a validator that double-signs a block. */
    Infraction["INFRACTION_DOUBLE_SIGN"] = "INFRACTION_DOUBLE_SIGN";
    /** INFRACTION_DOWNTIME - DOWNTIME defines a validator that missed signing too many blocks. */
    Infraction["INFRACTION_DOWNTIME"] = "INFRACTION_DOWNTIME";
    Infraction["UNRECOGNIZED"] = "UNRECOGNIZED";
...
function infractionToNumber(object) {
    switch (object) {
        case Infraction.INFRACTION_UNSPECIFIED:
            return 0;
        case Infraction.INFRACTION_DOUBLE_SIGN:
...
exports.infractionToNumber = infractionToNumber;
...
exports.HistoricalInfo = {
    ...
    fromJSON: function (object) {
        return {
            ...
            valset: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.valset) ? object.valset.map(function (e) { return exports.Validator.fromJSON(e); }) : [],
        };
    },
    toJSON: function (message) {
        ...
        if ((_a = message.valset) === null || _a === void 0 ? void 0 : _a.length) {
            obj.valset = message.valset.map(function (e) { return exports.Validator.toJSON(e); });
        }
        return obj;
    },
...
exports.Commission = {
    encode: function (message, writer) {
        ...
        if (message.commission_rates !== undefined) {
            exports.CommissionRates.encode(message.commission_rates, writer.uint32(10).fork()).join();
        }
        if (message.update_time !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.update_time), writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode: function (input, length) {
...
exports.Validator = {
    encode: function (message, writer) {
        ...
        if (message.consensus_pubkey !== undefined) {
            any_1.Any.encode(message.consensus_pubkey, writer.uint32(18).fork()).join();
        }
        ...
        if (message.unbonding_time !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.unbonding_time), writer.uint32(74).fork()).join();
        }
        ...
        for (var _i = 0, _a = message.unbonding_ids; _i < _a.length; _i++) {
            var v = _a[_i];
            writer.uint64(v);
        }
        writer.join();
    ...
    fromJSON: function (object) {
        return {
            ...
            unbonding_on_hold_ref_count: isSet(object.unbonding_on_hold_ref_count)
                ...
                : "0",
            unbonding_ids: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.unbonding_ids)
                ? object.unbonding_ids.map(function (e) { return globalThis.String(e); })
                : [],
        };
    },
    toJSON: function (message) {
    ...
    fromPartial: function (object) {
        ...
        message.unbonding_on_hold_ref_count = (_j = object.unbonding_on_hold_ref_count) !== null && _j !== void 0 ? _j : "0";
        message.unbonding_ids = ((_k = object.unbonding_ids) === null || _k === void 0 ? void 0 : _k.map(function (e) { return e; })) || [];
        return message;
    },
};
...
exports.DVPairs = {
    ...
    fromJSON: function (object) {
        return { pairs: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.pairs) ? object.pairs.map(function (e) { return exports.DVPair.fromJSON(e); }) : [] };
    },
    toJSON: function (message) {
        var _a;
        var obj = {};
        if ((_a = message.pairs) === null || _a === void 0 ? void 0 : _a.length) {
            obj.pairs = message.pairs.map(function (e) { return exports.DVPair.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
...
exports.DVVTriplets = {
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.triplets) === null || _a === void 0 ? void 0 : _a.length) {
            obj.triplets = message.triplets.map(function (e) { return exports.DVVTriplet.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
...
exports.UnbondingDelegation = {
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.entries) === null || _a === void 0 ? void 0 : _a.length) {
            obj.entries = message.entries.map(function (e) { return exports.UnbondingDelegationEntry.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
...
exports.UnbondingDelegationEntry = {
    encode: function (message, writer) {
        ...
        if (message.completion_time !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.completion_time), writer.uint32(18).fork()).join();
        }
    ...
    fromPartial: function (object) {
        ...
        message.unbonding_id = (_e = object.unbonding_id) !== null && _e !== void 0 ? _e : "0";
        message.unbonding_on_hold_ref_count = (_f = object.unbonding_on_hold_ref_count) !== null && _f !== void 0 ? _f : "0";
        return message;
    },
};
...
exports.Redelegation = {
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.entries) === null || _a === void 0 ? void 0 : _a.length) {
            obj.entries = message.entries.map(function (e) { return exports.RedelegationEntry.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
...
exports.Params = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = new wire_1.BinaryWriter(); }
        if (message.unbonding_time !== undefined) {
            duration_1.Duration.encode(message.unbonding_time, writer.uint32(10).fork()).join();
        }
...
exports.RedelegationEntryResponse = {
    encode: function (message, writer) {
        ...
        if (message.redelegation_entry !== undefined) {
            exports.RedelegationEntry.encode(message.redelegation_entry, writer.uint32(10).fork()).join();
        }
        if (message.balance !== "") {
            writer.uint32(34).string(message.balance);
        }
...
exports.RedelegationResponse = {
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.entries) === null || _a === void 0 ? void 0 : _a.length) {
            obj.entries = message.entries.map(function (e) { return exports.RedelegationEntryResponse.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
...
exports.ValidatorUpdates = {
    ...
    fromJSON: function (object) {
        return {
            updates: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.updates)
                ? object.updates.map(function (e) { return types_1.ValidatorUpdate.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if ((_a = message.updates) === null || _a === void 0 ? void 0 : _a.length) {
            obj.updates = message.updates.map(function (e) { return types_1.ValidatorUpdate.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
