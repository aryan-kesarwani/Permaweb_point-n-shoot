...
exports.QueryTeamVestingAccountsResponse = {
    encode: function (message, writer) {
        ...
        for (var _i = 0, _a = message.accounts; _i < _a.length; _i++) {
            var v = _a[_i];
            team_1.TeamVestingAccount.encode(v, writer.uint32(10).fork()).join();
        }
        return writer;
    },
    decode: function (input, length) {
...
exports.QueryTeamVestingAccountResponse = {
    encode: function (message, writer) {
        ...
        if (message.account !== undefined) {
            team_1.TeamVestingAccount.encode(message.account, writer.uint32(10).fork()).join();
        }
        return writer;
    },
    decode: function (input, length) {
...
exports.QueryTeamVestingStatusResponse = {
    encode: function (message, writer) {
        ...
        if (message.plan !== undefined) {
            exports.QueryVestingPlan.encode(message.plan, writer.uint32(18).fork()).join();
        }
        if (message.status !== undefined) {
            exports.QueryVestingStatus.encode(message.status, writer.uint32(26).fork()).join();
        }
        return writer;
    },
    decode: function (input, length) {
...
var QueryClientImpl = /** @class */ (function () {
    ...
    QueryClientImpl.prototype.TeamInfo = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryTeamInfoResponse.decode(new wire_1.BinaryReader(data)); });
    };
    QueryClientImpl.prototype.TeamVestingAccounts = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryTeamVestingAccountsResponse.decode(new wire_1.BinaryReader(data)); });
    };
    QueryClientImpl.prototype.TeamVestingAccount = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryTeamVestingAccountResponse.decode(new wire_1.BinaryReader(data)); });
    };
    QueryClientImpl.prototype.TeamVestingStatus = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryTeamVestingStatusResponse.decode(new wire_1.BinaryReader(data)); });
    };
    QueryClientImpl.prototype.TeamVestingStatusByTime = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryTeamVestingStatusByTimeResponse.decode(new wire_1.BinaryReader(data)); });
    };
