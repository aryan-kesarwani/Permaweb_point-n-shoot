...
exports.FinalizedBundle = {
    encode: function (message, writer) {
        ...
        if (message.finalized_at !== undefined) {
            exports.FinalizedAt.encode(message.finalized_at, writer.uint32(82).fork()).join();
        }
        ...
        if (message.stake_security !== undefined) {
            exports.StakeSecurity.encode(message.stake_security, writer.uint32(114).fork()).join();
        }
        return writer;
    },
...
exports.QueryFinalizedBundlesResponse = {
    encode: function (message, writer) {
        ...
        for (var _i = 0, _a = message.finalized_bundles; _i < _a.length; _i++) {
            var v = _a[_i];
            exports.FinalizedBundle.encode(v, writer.uint32(10).fork()).join();
        }
        if (message.pagination !== undefined) {
...
exports.QueryCanValidateRequest = {
    ...
    fromPartial: function (object) {
        ...
        var message = createBaseQueryCanValidateRequest();
        message.pool_id = (_a = object.pool_id) !== null && _a !== void 0 ? _a : "0";
        message.pool_address = (_b = object.pool_address) !== null && _b !== void 0 ? _b : "";
        return message;
    },
};
...
var QueryBundlesClientImpl = /** @class */ (function () {
    ...
    QueryBundlesClientImpl.prototype.FinalizedBundlesQuery = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryFinalizedBundlesResponse.decode(new wire_1.BinaryReader(data)); });
    };
    QueryBundlesClientImpl.prototype.FinalizedBundleQuery = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryFinalizedBundleResponse.decode(new wire_1.BinaryReader(data)); });
    };
    QueryBundlesClientImpl.prototype.CurrentVoteStatus = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryCurrentVoteStatusResponse.decode(new wire_1.BinaryReader(data)); });
    };
    QueryBundlesClientImpl.prototype.CanValidate = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryCanValidateResponse.decode(new wire_1.BinaryReader(data)); });
    };
    QueryBundlesClientImpl.prototype.CanPropose = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryCanProposeResponse.decode(new wire_1.BinaryReader(data)); });
    };
    QueryBundlesClientImpl.prototype.CanVote = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryCanVoteResponse.decode(new wire_1.BinaryReader(data)); });
    };
