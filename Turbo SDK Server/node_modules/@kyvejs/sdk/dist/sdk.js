...
var KyveSDK = /** @class */ (function () {
     ...
     * @return boolean
     */
    KyveSDK.prototype.isMainnet = function () {
        return this.config.chainId === constants_1.MAINNET_CHAIN_ID;
    };
    /**
     * check if sdk is connected to the kyve testnet
     * @return boolean
     */
    KyveSDK.prototype.isTestnet = function () {
        return this.config.chainId === constants_1.TESTNET_CHAIN_ID;
    };
    /**
     * check if sdk is connected to the kyve devnet
     * @return boolean
     */
    KyveSDK.prototype.isDevnet = function () {
        return this.config.chainId === constants_1.DEVNET_CHAIN_ID;
    };
    /**
     * check if sdk is connected to the kyve local chain
     * @return boolean
     */
    KyveSDK.prototype.isLocal = function () {
        return this.config.chainId === constants_1.LOCAL_CHAIN_ID;
    };
    return KyveSDK;
}());
