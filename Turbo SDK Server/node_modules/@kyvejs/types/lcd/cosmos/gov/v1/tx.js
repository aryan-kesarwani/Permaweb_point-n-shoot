...
exports.MsgCancelProposalResponse = {
    encode: function (message, writer) {
        ...
        if (message.canceled_time !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.canceled_time), writer.uint32(18).fork()).join();
        }
...
var MsgClientImpl = /** @class */ (function () {
    ...
    MsgClientImpl.prototype.SubmitProposal = function (request) {
        ...
        return promise.then(function (data) { return exports.MsgSubmitProposalResponse.decode(new wire_1.BinaryReader(data)); });
    };
    MsgClientImpl.prototype.ExecLegacyContent = function (request) {
        ...
        return promise.then(function (data) { return exports.MsgExecLegacyContentResponse.decode(new wire_1.BinaryReader(data)); });
    };
    MsgClientImpl.prototype.Vote = function (request) {
        ...
        return promise.then(function (data) { return exports.MsgVoteResponse.decode(new wire_1.BinaryReader(data)); });
    };
    MsgClientImpl.prototype.VoteWeighted = function (request) {
        ...
        return promise.then(function (data) { return exports.MsgVoteWeightedResponse.decode(new wire_1.BinaryReader(data)); });
    };
    MsgClientImpl.prototype.Deposit = function (request) {
        ...
        return promise.then(function (data) { return exports.MsgDepositResponse.decode(new wire_1.BinaryReader(data)); });
    };
    ...
    MsgClientImpl.prototype.CancelProposal = function (request) {
        ...
        return promise.then(function (data) { return exports.MsgCancelProposalResponse.decode(new wire_1.BinaryReader(data)); });
    };
