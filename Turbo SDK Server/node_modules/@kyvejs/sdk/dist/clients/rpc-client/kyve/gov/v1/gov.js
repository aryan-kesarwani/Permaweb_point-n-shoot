...
var KyveGovMsg = /** @class */ (function (_super) {
    ...
    KyveGovMsg.prototype.updateParamsMultiCoinRewards = function (value, deposit, title, summary, metadata, options) {
        var _this = this;
        var tx = this.createGovTx(tx_registry_1.encodeTxMsg.updateParamsMultiCoinRewards(__assign(__assign({}, value), { authority: constants_1.GOV_AUTHORITY })), deposit, title, summary, metadata);
        return new signing_1.PendingTx({ tx: [tx] }, function () {
            return _this.getPendingSignedTx(tx, options);
        });
    };
