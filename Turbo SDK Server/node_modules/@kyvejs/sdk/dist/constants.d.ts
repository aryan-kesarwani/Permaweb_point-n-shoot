...
export declare const VAL_PREFIX = "kyvevaloper";
export declare const GOV_AUTHORITY = "kyve10d07y265gmmuvt4z0w9aw880jnsr700jdv7nah";
export declare const GAS_MULTIPLIER = 1.5;
export declare const COIN_TYPE = 118;
export declare const MAINNET_CHAIN_ID = "kyve-1";
export declare const TESTNET_CHAIN_ID = "kaon-1";
export declare const DEVNET_CHAIN_ID = "korellia-2";
export declare const LOCAL_CHAIN_ID = "kyve-local";
export type IConfig = {
    chainId: string;
    chainName: string;
    rpc: string;
...
export declare const KYVE_LEAP_CONFIG: ChainInfo;
