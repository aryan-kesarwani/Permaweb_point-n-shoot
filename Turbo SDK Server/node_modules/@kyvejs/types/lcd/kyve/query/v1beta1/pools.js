...
exports.QueryPoolsResponse = {
    encode: function (message, writer) {
        ...
        for (var _i = 0, _a = message.pools; _i < _a.length; _i++) {
            var v = _a[_i];
            exports.PoolResponse.encode(v, writer.uint32(10).fork()).join();
        }
        if (message.pagination !== undefined) {
...
exports.PoolResponse = {
    encode: function (message, writer) {
        ...
        if (message.data !== undefined) {
            pool_1.Pool.encode(message.data, writer.uint32(18).fork()).join();
        }
        if (message.bundle_proposal !== undefined) {
            bundles_1.BundleProposal.encode(message.bundle_proposal, writer.uint32(26).fork()).join();
        }
        ...
        for (var _b = 0, _c = message.fundings; _b < _c.length; _b++) {
            var v = _c[_b];
            funders_1.Funding.encode(v, writer.uint32(82).fork()).join();
        }
        return writer;
    },
    decode: function (input, length) {
...
exports.QueryPoolResponse = {
    encode: function (message, writer) {
        ...
        if (message.pool !== undefined) {
            exports.PoolResponse.encode(message.pool, writer.uint32(10).fork()).join();
        }
        return writer;
    },
    decode: function (input, length) {
...
var QueryPoolClientImpl = /** @class */ (function () {
    ...
    QueryPoolClientImpl.prototype.Pools = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryPoolsResponse.decode(new wire_1.BinaryReader(data)); });
    };
    QueryPoolClientImpl.prototype.Pool = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryPoolResponse.decode(new wire_1.BinaryReader(data)); });
    };
